...
class Dots {
	...
	ghost() {
		...
		dotsCtx.fillStyle = 'rgb(148, 21, 7)';
...
class Circuits {
	...
	draw() {
		...
		ctx.strokeStyle = 'rgba(17, 115, 6, 0.54)';
...
class Things {
	...
	setLight(lightRadius) {
		...
		gradient.addColorStop(1, "rgba(37, 203, 223,  .1)");
...
// background init
const bgCanvas = document.getElementById('nav-background'),
